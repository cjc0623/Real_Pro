...
public class FeesAdminController {
    ...
    public ResponseEntity<Void> addBasicRow(@RequestBody RowRequest req) {
        String weight = trim(firstNonEmpty(req.getWeight(), req.getName()));
        ...
        FeesBasic row = feesBasicRepository.findByWeight(weight)
                .orElseGet(() -> FeesBasic.builder()
                        .weight(weight)
                        .cargoName(firstNonEmpty(req.getCargoName(), "미지정"))
    ...
    public ResponseEntity<Void> addExtraRow(@RequestBody RowRequest req) {
        String title = trim(firstNonEmpty(
                req.getTitle(),
                req.getName(),
                req.getExtraChargeTitle()
        ));
    ...
    public ResponseEntity<Map<String, String>> imageupload(
