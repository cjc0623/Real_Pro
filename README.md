...
- 차주 본인 차량의 적재 톤 수와 화물 무게를 비교하여, 조건에 맞지 않는 화물은 수락 불가하도록 검증 로직 적용
...
- 썸네일 이미지 자동 생성 기능 적용
  (목록 화면에서는 썸네일 이미지 사용, 상세 화면에서는 원본 이미지 제공)
- 차주 답글 기능 제공

---

### 👤 8. 차주 프로필 및 신뢰도 분석 시스템
...
- 차량 승인 관리 기능
  - 차주가 등록한 차량 정보(톤 수, 차종, 서류 등) 검토
  - 차주가 등록한 차량 정보 조회 및 서비스 이용 승인/반려 기능
- 신고 처리 및 사용자 제재 기능
- 공지사항 및 게시글 관리 기능
